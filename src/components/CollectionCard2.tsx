...
const CollectionCard2: FC<CollectionCard2Props> = ({
  ...
  return (
    <div className={`CollectionCard2 group relative ${className}`}>
      ...
      <div className="relative mt-5 ">
        ...
        <div className="mt-2 flex justify-between">
          <div className="flex items-center  truncate">
            <Avatar sizeClass="h-6 w-6" imgUrl={creatorPhoto} />
            <div className="ml-2 text-sm truncate">
              ...
              <span className="font-medium">
                {creatorName && creatorName !== "" ? creatorName : "No Name"}
              </span>
            </div>
      ...
      <Link
        to={{
          pathname: "/page-collection/" + id,
          state: { coverImage: imgs[0], collectionImage: imgs[1] },
        }}
