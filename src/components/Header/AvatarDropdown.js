...
// import { imageURLtransfer } from "../../containers/AccountPage/AccountPage"

const AvatarDropdown = (props) => {
  const [abc, setAbc] = useState("");
  const currentUser = useAuth();
  // console.log(currentUser)
  // const imageURL = imageURLtransfer();
  ...
  return (
    <div className="AvatarDropdown">
      {currentUser === null ? (
        <Link to="/signup">
          <img className="defualt-avatar" src={defaultavatar} />
        </Link>
      ) : (
            ...
            <>
              ...
              >
                <img
                  ...
                  className="header-prof-pic smart"
                  id="header-prof-pic"
                />
              </Popover.Button>
              <Transition
                  ...
                  <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5">
                    <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                      ...
                      >
                        ...
                        <div className="ml-4">
                          <p className="text-sm font-medium " onClick={logout}>
                            {"Disconnect"}
                          </p>
                        </div>
                      </Link>
