...
const SectionSliderCollections2: FC<SectionSliderCollections2Props> = ({
  ...
  //   getCollections();
  // }, []);
  const getMintDataFromCollectionId = async () => {};

  // useEffect(() => {
  //   getMintDataFromCollectionId();
  ...
  return (
    <div
      className={`nc-SectionSliderCollections2 ${className}`}
      data-aos="zoom-in"
    >
      ...
      {/* <div className={`${UNIQUE_CLASS} relative`} ref={sliderRef}>
        <div className="glide__track" data-glide-el="track">
          <ul className="glide__slides">
            {collectionsTemp &&
            collectionsTemp != null &&
            collectionsTemp.length > 0 ? (
              collectionsTemp.map((collec, index) => (
